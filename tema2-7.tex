...
Ejemplo: \textbf{prologo(1,7)}
  ...
  \begin{tikzpicture}
    ...
    \uncover<2->{\draw[-latex] ($(etq11.south)+(0,0.2)$) -- ($(x11.south)-(0,0.4)$) -- ($(x2.south)-(0,0.4)$) -- (x2.south);};
...
\begin{tikzpicture}
    ...
    \node[box, right = of x3, fill=blue!40, minimum width=1em] (x4) {\tiny{1}};
    \node[box, right = of x4, fill=blue!40, minimum width=1em] (x5) {\tiny{5}};
    \node[box, right = of x5, fill=blue!40, minimum width=1em] (x6) {\tiny{8}};
    \node[box, right = of x6, fill=blue!40, minimum width=1em] (x7) {\tiny{12}};
    \node[box, right = of x7, fill=blue!40, minimum width=1em] (x8) {\tiny{res}};
    ...
    \uncover<2->{
      \node[box, short, right = of x10, fill=cyan!40, minimum width=1.2em] (x11) {\tiny{1}};
      \node[box, short, right = of x11, fill=cyan!40, minimum width=1.2em] (x12) {\tiny{5}};
    };
    \uncover<2>{
      \node[box, short, right = of x12, fill=cyan!40, minimum width=1.2em] (x13) {\tiny{?}};
      \node[box, short, right = of x13, fill=cyan!40, minimum width=1.2em] (x14) {\tiny{?}};
    ...
    \uncover<3->{
      \node[box, short, right = of x12, fill=cyan!40, minimum width=1.2em] (x13) {\tiny{8}};
      \node[box, short, right = of x13, fill=cyan!40, minimum width=1.2em] (x14) {\tiny{12}};
...
\begin{tikzpicture}
    ...
    % sumaCuadrado
    \node[box, short, right = of x17, fill=cyan!40, minimum width=1.2em] (x18) {\tiny{217}};
    \node[box, short, right = of x18, fill=cyan!40, minimum width=1.2em] (x19) {\tiny{?}};
    ...
    % 6
    \uncover<2->{
      \node[box, short, right = of x19, fill=cyan!40, minimum width=1.2em] (x20) {\tiny{6}};
      \node[box, short, right = of x20, fill=cyan!40, minimum width=1.2em] (x21) {\tiny{?}};
    };
    \uncover<2-2>{
    ...
    \uncover<3->{
      \node[box, short, right = of x19, fill=cyan!40, minimum width=1.2em] (x20) {\tiny{6}};
      \node[box, short, right = of x20, fill=cyan!40, minimum width=1.2em] (x21) {\tiny{7}};
    };
    \uncover<3-3>{
...
\begin{tikzpicture}
    ...
    % main
    \node[box, right = of x1, fill=blue!40, minimum width=1em] (x4) {\tiny{1}};
    \node[box, right = of x4, fill=blue!40, minimum width=1em] (x5) {\tiny{5}};
    \node[box, right = of x5, fill=blue!40, minimum width=1em] (x6) {\tiny{8}};
    \node[box, right = of x6, fill=blue!40, minimum width=1em] (x7) {\tiny{12}};
    \node[box, right = of x7, fill=blue!40, minimum width=1em] (x8) {\tiny{res}};
    ...
    \uncover<1-1>{
      \node[box, short, right = of x14, fill=cyan!40, minimum width=1.7em] (x15) {\tiny{?}};
    }
    \uncover<2->{
      \node[box, short, right = of x14, fill=cyan!40, minimum width=1.2em] (x15) {\tiny{0x8}};
    };
    \uncover<2-2>{
      \uncover<2->{\draw[-latex] ($(etq8.south)+(0,0.2)$) -- ($(x8.south)-(0,0.4)$) -- ($(x15.south)-(0,0.4)$) -- (x15.south);};
    }
...
\end{tabular*}
	...
	\begin{tikzpicture}
		...
		\node[box, short, right = of x13, fill=cyan!40, minimum width=1.2em] (x14) {\tiny{12}};
		\node[box, short, right = of x14, fill=cyan!40, minimum width=1.2em] (x15) {\tiny{0x8}};
		\node[box, short, right = of x15, fill=cyan!40, minimum width=1.2em] (x16) {\tiny{a}};
		\node[box, short, right = of x16, fill=cyan!40, minimum width=1.2em] (x17) {\tiny{b}};
