...
Ejemplo: \textbf{apila-ret(0x87)} , siendo 0x87 el nº de instrucción.
  ...
  \begin{tikzpicture}
    ...
    \uncover<-1>{\node[box, right = of x8, minimum width=2.49em] (x9) {\tiny{?}};};
    ...
    \node[box, draw=none, above = of x0] {\small{0}};
    \node[box, draw=none, above = of x4.north] {\small{4}};
    \node[box, draw=none, above = of x8.north] {\small{8}};
    \node[box, draw=none, above = of x12] {\small{12}};
...
Ejemplo: \textbf{prologo(1,7)}
	...
	minimum height=2em, minimum width=2em, align=center},short/.style={minimum width = 1.8em}]
		...
		\uncover<2->{\node[box, fill=red!40] at (0,0) (x0) {\small{0x16}};};
		...
		\uncover<-1>{
		  \node[box, short, right = of x10] (x11) {\tiny{?}};
		  \node[box, short, right = of x11] (x12) {\tiny{?}};
		  \node[box, short, right = of x12] (x13) {\tiny{?}};
		  \node[box, short, right = of x13] (x14) {\tiny{?}};
		  \node[box, short, right = of x14] (x15) {\tiny{?}};
		  \node[box, short, right = of x15] (x16) {\tiny{?}};
		  };
		\uncover<2->{
		  \node[box, short, right = of x10, fill=cyan!40] (x11) {\tiny{?}};
		  \node[box, short, right = of x11, fill=cyan!40] (x12) {\tiny{?}};
		  \node[box, short, right = of x12, fill=cyan!40] (x13) {\tiny{?}};
		  \node[box, short, right = of x13, fill=cyan!40] (x14) {\tiny{?}};
		  \node[box, short, right = of x14, fill=cyan!40] (x15) {\tiny{?}};
		  \node[box, short, right = of x15, fill=cyan!40] (x16) {\tiny{?}};
		  };

		\node[box, short, right = of x16] (x17) {\tiny{?}};
...
\begin{tikzpicture}
    ...
    \node[box, draw=none, above = of x0] {\small{0}};
    \node[box, draw=none, above = of x8.north west] {\small{4}};
    \node[box, draw=none, above = of x8.north east] {\small{8}};
    \node[box, draw=none, above = of x12] {\small{12}};
    \node[box, draw=none, above = of x16] {\small{16}};
...
Ejemplo: \textbf{epilogo(1)}
  ...
  \begin{tikzpicture}
    ...
    \node[box, right = of x0, fill=green!40] (x1) {\small{0x4}};
    \uncover<-1>{\node[box, right = of x1, fill=green!40] (x2) {\small{0x11}};}
    \uncover<2->{\node[box, right = of x1, fill=green!40] (x2) {\small{¿?}};}
    ...
    \node[box, right = of x8, fill=pink!40] (x9) {0x87};
    \node[box, right = of x9, fill=pink!40] (x10) {\small{¿?}};
    \node[box, right = of x10, fill=cyan!40] (x11) {\tiny{?}};
    \node[box, right = of x11, fill=cyan!40] (x12) {\tiny{?}};
