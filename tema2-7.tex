...
Ejemplo: apila-ret(0x87) , siendo 0x87 el nº de instrucción.
  ...
  \begin{tikzpicture}
    ...
    \node[box, right = of x12] (x13) {};
    \node[box, right = of x13] (x14) {\ldots};
    ...
    \uncover<1->{\draw[-latex, dashed] (x1.south) -- ($(x1.south)-(0,0.2)$) -- ($(x8.south west)-(0,0.2)+(0.1,0)$) -- ($(x8.south west)+(0.1,0)$);};
    \uncover<1->{\draw[-latex, dashed] (x0.south) -- ($(x0.south)-(0,0.5)$) -- ($(x9.south west)-(0.1,0.5)$) -- ($(x9.south west)-(0.1,0)$);};
