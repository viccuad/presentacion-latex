...
\column{.6\textwidth}
	\begin{center}
      ...
      \node [etq, above = of D] {\small{Disp3}};
		  ...
		  \uncover<3-3>{\draw[-latex, dashed] ($(C.south)-(0.2,0)$) |- (regE.west);}
      \uncover<4-4>{\draw[-latex, dashed] ($(C.south)-(0.2,0)$) |- (regC.west);}
      \uncover<5-5>{\draw[-latex, dashed] ($(C.south)-(0.2,0)$) |- (regE.west);}
