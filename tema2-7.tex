	...
	\begin{center}
		\begin{tikzpicture}
		  ...
		  \begin{scope}[every node/.style={draw, rectangle, node distance=0pt, outer sep=0pt}]
			  \node (A) at (0,0) {0x09};
			  \node [right = of A] (B) {0x13};
			  \node [right = of B] (C) {0x24};
			  \node [right = of C] (D) {0x65};
		  \end{scope}
...
por hacer. hay que hacer unas cuantas traspas moviendo los displays.
molaria tener los displays etiquetados con nivel 1 etc

\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Nueva arquitectura}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Memoria}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]
...
\column{.5\textwidth}
	...
	[.main()
	    [.{main: Prellamada}
	        [.{Ir-a}
		        [.{subprograma: \color{green}{Prólogo}}
		        	[.{subprograma: Cuerpo}
		        		[.{subprograma: epílogo}
			        		[.{Ir-ind}
				        		[.{main: Postllamada}
	...
	[.main()
	    [.{main: Prellamada}
	        [.{Ir-a}
		        [.{subprograma: Prólogo}
		        	[.{subprograma: Cuerpo}
		        		[.{subprograma: \color{green}{epílogo}}
			        		[.{Ir-ind}
				        		[.{main: Postllamada}
		        				]
		        			]
